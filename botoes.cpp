...
process main(void) {
    ...
    kprintf("Pressione os botões de 0 a 9 para configurar o tempo do micro-ondas.\n");
    while (TRUE) {
        kprintf("\nPressione um botão (0-9 para configurar, -1 para iniciar): ");
        botao = getnum();
        ...
        if (botao == -1) {
            ...
            kprintf("\nBotão inválido. Digite um número de 0 a 9 ou -1 para iniciar.\n");
        }
    }
